    ...
    return (
        <div className="min-h-screen flex flex-col" style={{ background: "#f4f3fb" }}>
            ...
            <div className="relative h-56 sm:h-72 lg:h-[380px] overflow-hidden shrink-0">
                ...
                />
                <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, rgba(8,8,15,0.1) 0%, rgba(8,8,15,0.5) 65%, #08080f 100%)" }} />
            ...
            <header className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, #08080f 0%, #1a0a2e 50%, #0f0520 100%)" }}>
                ...
                <div className="relative z-10 border-b border-white/5">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                        <Image src="/logo.png" alt="Crossroads Custom Apparel" width={44} height={44} className="object-contain rounded-lg" priority />
            ...
            <main className="flex-1">
                ...
                <section id="shops" className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
                    <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }}
                        ...
                        <div>
                            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight mb-2">Shops Open Now</h2>
                            <p className="text-sm sm:text-base text-slate-500">Have a link already? Jump straight to it below.</p>
                        </div>
                    ...
                    {shops === null ? (
                        ...
                        <div className="text-center bg-white rounded-2xl ring-1 ring-black/5 py-16 px-6">
                            ...
                            <p className="text-slate-600 font-semibold">No shops are open right now.</p>
                            <p className="text-sm text-slate-400 mt-1">Check back soon, or reach out below to get one set up.</p>
                        </div>
                    ) : (
                        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} variants={stagger}
                            className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <footer className="border-t border-slate-200 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <Image src="/logo.png" alt="Crossroads Custom Apparel" width={44} height={44} className="object-contain" />
