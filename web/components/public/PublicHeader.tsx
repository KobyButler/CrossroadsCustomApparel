...
export function PublicHeader({
    ...
    return (
        <div className="border-b border-plate-800">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    {backHref && (
                        <Link href={backHref} title={backLabel} className="flex items-center gap-2 group">
                            <span className="w-7 h-7 rounded-md bg-plate-800 border border-plate-700 flex items-center justify-center text-plate-300 group-hover:text-plate-100 group-hover:bg-plate-700 transition-colors shrink-0">
